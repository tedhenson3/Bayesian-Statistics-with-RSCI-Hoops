...
The same model definitions above were applied, but Markov Chain Monte Carlo methods were applied to estimate the posterior distrubtion for the parameters. Below beta[1] is the mean of the response, beta[2] for Big, beta[3] for Guard, beta[4] for composite rating, and beta[5] for age.
```{r}
